...
7. For performing a batch import of multiple labware files, open the opentrons folder in which all the labware are defined. It's possible just to remove all the JSON files and take them from `\\158.194.103.28\domling\Instrument_OT-2\labware_json_V2`.

![Opentrons Batch Import](figures/opentrons_batch_import.png)
