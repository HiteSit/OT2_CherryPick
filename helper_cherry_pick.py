...
def create_json_config(labware_toml, settings_toml, csv_file, verbose=True):
...
def update_protocol_file(protocol_file, json_config, verbose=True):
...
def generate_protocol(labware_toml_path, settings_toml_path, csv_path,
                     protocol_path, verbose=False):
    """
